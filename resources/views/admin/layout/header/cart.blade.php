                ...
                <div class="kt-mycart__body kt-scroll" data-scroll="true" data-height="245"
                    ...
                    <div class="kt-mycart__item">
                        <div class="kt-mycart__container">
                            ...
                            <a href="#" class="kt-mycart__pic">
                                <img src="{{ asset('assets/admin/media/products/product9.jpg') }}" title="">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="kt-mycart__item">
                        <div class="kt-mycart__container">
                            ...
                            <a href="#" class="kt-mycart__pic">
                                <img src="{{ asset('assets/admin/media/products/product13.jpg') }}" title="">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="kt-mycart__item">
                        <div class="kt-mycart__container">
                            ...
                            <a href="#" class="kt-mycart__pic">
                                <img src="{{ asset('assets/admin/media/products/product16.jpg') }}" title="">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="kt-mycart__item">
                        <div class="kt-mycart__container">
                            ...
                            <a href="#" class="kt-mycart__pic">
                                <img src="{{ asset('assets/admin/media/products/product15.jpg') }}" title="" alt="">
                            </a>
                        </div>
                    </div>
                </div>
