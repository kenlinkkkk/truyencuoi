            ...
            <ul class="kt-menu__nav ">
                <li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true">
                    <a href="{{ route('admin.index') }}" class="kt-menu__link ">
                        ...
                        <span class="kt-menu__link-text">Trang chủ</span>
                    </a>
                </li>
                ...
                <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                    <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                        ...
                        <span class="kt-menu__link-text">Quản lý</span>
                    ...
                    <div class="kt-menu__submenu ">
                        ...
                        <ul class="kt-menu__subnav">
                            <li class="kt-menu__item kt-menu__item--parent" aria-haspopup="true"><span
                                    class="kt-menu__link"><span class="kt-menu__link-text">Cửa hàng</span></span>
                            </li>
                            <li class="kt-menu__item" aria-haspopup="true">
                                <a href="{{ route('admin.post.index') }}" class="kt-menu__link ">
                                    <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
                                    <span class="kt-menu__link-text">Bài viết</span>
                                </a>
                            </li>
                            @if(\Illuminate\Support\Facades\Auth::user()->role == 0)
                                <li class="kt-menu__item " aria-haspopup="true">
                                    <a href="{{ route('admin.category.index') }}" class="kt-menu__link ">
                                        <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
                                        <span class="kt-menu__link-text">Danh mục</span>
                                    </a>
                                </li>
{{--                                <li class="kt-menu__item " aria-haspopup="true">--}}
{{--                                    <a href="{{ route('admin.slide.index') }}" class="kt-menu__link ">--}}
{{--                                        <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>--}}
{{--                                        <span class="kt-menu__link-text">Slide</span>--}}
{{--                                    </a>--}}
{{--                                </li>--}}
{{--                                <li class="kt-menu__item " aria-haspopup="true">--}}
{{--                                    <a href="{{ route('admin.promotion.index') }}" class="kt-menu__link ">--}}
{{--                                        <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>--}}
...
{{--                                <a href="javascript:" class="kt-menu__link kt-menu__toggle">--}}
{{--                                    <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>--}}
{{--                                    <span class="kt-menu__link-text">Wizard</span>--}}
{{--                                    <i class="kt-menu__ver-arrow la la-angle-right"></i>--}}
{{--                                </a>--}}
{{--                                <div class="kt-menu__submenu ">--}}
{{--                                    <span class="kt-menu__arrow"></span>--}}
