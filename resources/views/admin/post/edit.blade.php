            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="kt-portlet">
                        ...
                        <form class="kt-form kt-form--label-right" method="post" action="{{ route('admin.post.update', [$post->id]) }}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <input class="form-control" type="text" name="short_tag" value="{{ $post->short_tag }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <textarea class="tinymce form-control" name="content" style="height: 300px">{!! $post->content !!}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
