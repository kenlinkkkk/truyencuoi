...
{{--                            </div>--}}
                        ...
                        <div class="kt-widget__body">
                            ...
                            <div class="kt-widget__items">
                                <a  href="{{ route('admin.change_info') }}" class="kt-widget__item kt-widget__item--active">
                                ...
                                <a href="{{ route('admin.change_password') }}" class="kt-widget__item ">
                                    <span class="kt-widget__section">
                                        <span class="kt-widget__icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <div class="col-xl-12">
                    <div class="kt-portlet">
                        <div class="kt-portlet__head">
                            <div class="kt-portlet__head-label">
                                <h3 class="kt-portlet__head-title">Thông tin cá nhân <small>Cập nhật thông tin cá nhân</small></h3>
                            </div>
                        </div>

                        <form class="kt-form kt-form--label-right" method="post" action="{{ route('admin.info') }}" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="kt-section__body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <h3 class="kt-section__title kt-section__title-sm">Thông tin cá nhân:</h3>
                                            </div>
                                        </div>
...
{{--                                        </div>--}}
                                        ...
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">Tài khoản</label>
                                            <div class="col-lg-9 col-xl-6">
                                        ...
                                        <div class="row">
                                            <label class="col-xl-3"></label>
                                            <div class="col-lg-9 col-xl-6">
                                                <h3 class="kt-section__title kt-section__title-sm">Thông tin liên lạc:</h3>
                                            </div>
                                        </div>
                                        <div class="form-group row">
