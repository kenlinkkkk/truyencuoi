            ...
            <div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
                <div class="kt-login__container">
                    <div class="kt-login__logo">
                        <a href="#">
                            <img src="{{ asset('assets/main/images/logo4-light.png') }}">
                        </a>
                    </div>
                    <div class="kt-login__signin">
                        <div class="kt-login__head">
                            <h3 class="kt-login__title">Đăng nhập</h3>
                        </div>
                        <form class="kt-form" action="{{ route('login') }}" method="post">
                            @csrf
                            <div class="input-group">
                                <input class="form-control" type="text" placeholder="Admin" name="user_name" autocomplete="off" required>
                            </div>
                            <div class="input-group">
...
{{--                            </div>--}}
                            <div class="kt-login__actions">
                                <button target="_blank" type="submit" class="btn btn-pill kt-login__btn-primary">Đăng nhập</button>
                            </div>
                        </form>
                    </div>
